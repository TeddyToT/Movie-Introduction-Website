...
const AppHeader: React.FC = () => {
  ...
  `}
    >
      <div className="w-11/12 mx-auto text-white flex justify-between items-center px-4 py-3">
        <p className="hidden md:block md:w-1/3">LOGO</p>
        <ul className=" flex gap-5 w-full md:w-1/3 md:justify-end justify-between font-semibold md:text-2xl text-lg">
